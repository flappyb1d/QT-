...
//信号与槽的关联
    ...
    //登录
    connect(ui->login_button,&QPushButton::clicked,this,&ChatLogin::login);
    //注册
    connect(ui->mmregister_button,&QPushButton::clicked,this,&ChatLogin::register_account);
    //找回密码
    connect(ui->lost_password_button,&QPushButton::clicked,this,&ChatLogin::find_password);
    //记住
    connect(ui->remember_account_box,&QCheckBox::clicked,this,&ChatLogin::remember_account);
    //自动登录
    connect(ui->auto_login_box,&QCheckBox::clicked,this,&ChatLogin::auto_login);

}

//登录
void ChatLogin::login()
{
    //登录时按钮文本
...
//记住账号
void ChatLogin::remember_account()
{
    rememberAccountFlag = ui->remember_account_box->checkState();
...
//自动登录
void ChatLogin::auto_login()
{
    autoLoginFlag = ui->auto_login_box->checkState();
}

//注册
void ChatLogin::register_account()
{
    //未打开注册页面
...
//关闭
void ChatLogin::getClose(bool flag)
{
    if(true == flag){
...
//关闭注册页面
void ChatLogin::getRegisterClose(bool flag)
{
...
void ChatLogin::getFindClose(bool flag)
{
